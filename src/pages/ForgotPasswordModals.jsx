      ...
      >
        ...
        <Modal.Body>
          <Form onSubmit={handleVerifyOtp}>
            <Form.Label style={{ fontSize: "18px", color: "#999" }} className='mb-4'>
            ...
            <div className="text-center mt-3">
              {countdown > 0 ? (
                ...
                <Button variant="link" onClick={handleForgotPasswordSubmit} style={{ color: "#2D008C", }} >
                  Resend OTP
                </Button>
              )}
            </div>
            <div className="d-flex justify-content-center">
              <Button type="submit" variant="primary" className="mt-3 forgot-flow-cta">
                Verify OTP
              </Button>
            </div>
          </Form>
...
//                 <Button variant="link" style={{ color: "#2D008C", }} onClick={handleForgotPasswordSubmit}>
//                   Resend OTP
//                 </Button>
//               )}
//             </div>
